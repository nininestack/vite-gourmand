...
<link href="https://fonts.googleapis.com/css2?family=Libre+Barcode+39+Extended+Text&display=swap" rel="stylesheet">
        ...
        <link rel="stylesheet" href="public/assets/css/menus.css">
        <link rel="stylesheet" href="public/assets/css/img.css">
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <!-- AFFICHE MENU SELECTIONNE-->
    ...
    <body>
        ...
        <!-- LOGO, NAVIGATION ET ICONES -->
            ...
            <div class="header-icons">
                ...
                <a href="user.php">
                    <img src="public/assets/img/acompte.png"
                    alt="MON COMPTE"
                    class="icon">
                </a>

                <a href="commande.php">
                    <img src="public/assets/img/apanier.png"
                    alt="MA COMMANDE"
                    class="icon">
                </a>
